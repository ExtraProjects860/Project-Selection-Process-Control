...
function RegistrationsCandidate({ updateTrigger, onLoaded }) {
  ...
  const handleFormResponded = async (idStatusProcessoSeletivo) => {
    try {
      await markFormAsResponded(idStatusProcessoSeletivo);
      setIsFormResponded(true); // Atualiza o estado local para indicar que o formulário foi respondido
      setSelectedRegistration((prev) => ({
        ...prev,
        forms_respondido: 1, // Atualiza o campo no estado local
      }));
    } catch (error) {
          ...
          <div className="modal-overlay">
            <div className="modal-content">
              ...
              <p>
                ...
                {selectedRegistration.data_encerramento !== "None"
                  ? selectedRegistration.data_encerramento
                  : "Data não marcada"}
              </p>
              <p>
                Data da Entrevista:{" "}
              ...
              <p
                style={{
                  color:
                    selectedRegistration.forms_respondido === 0
                      ? "red"
                      : "black",
                }}
              >
              ...
              {selectedRegistration.forms_respondido === 0 && !isFormResponded && (
