...
function EditModal({ show, candidate, onSave, onClose }) {
  const [formData, setFormData] = useState({
    ...
    data_entrevista: "",
    data_conclusao: "",
    forms_respondido: "NAO", // Valor padrão
    avaliacao_forms: "",
    perfil: "",
  });
  ...
  useEffect(() => {
    if (candidate) {
      ...
      setFormData({
        ...
        status: candidate.status_processo || "",
        observacao: candidate.observacao || "",
        data_entrevista: candidate.data_entrevista || "",
        data_conclusao: candidate.data_conclusao || "",
  ...
  const handleSubmit = async () => {
    ...
    const updatedData = {
      data_entrevista: formData.data_entrevista === "None" ? "NULL" : formData.data_entrevista,
      data_conclusao: formData.data_conclusao === "None" ? "NULL" : formData.data_conclusao,
      status_processo: formData.status,
        ...
        <Form>
          ...
          <Form.Group controlId="formDataConclusao">
            ...
            <Form.Control
              ...
              placeholder="AAAA-MM-DD 00:00" // Impede a seleção de datas anteriores à data da entrevista
            />
          </Form.Group>
