...
@status_processo_seletivo_routes.route('/pegar-vagas-etapas', methods=['GET'], strict_slashes=False)
@jwt_required()
...
def pegar_etapas() -> tuple[Response, int]:
    try:
        status_processo_seletivo_controller: StatusProcessoSeletivoController = StatusProcessoSeletivoController()
        _, etapas = status_processo_seletivo_controller.pegar_vagas_etapas()
...
def atualizar_status_processo_seletivo(id_status_processo_seletivo: int) -> tuple[Response, int]:
    try:
        ...
        status_processo_seletivo_controller.atualizar_status_processo_seletivo(id_status_processo_seletivo, body["etapa"])
